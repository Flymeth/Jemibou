module.exports = {
    ...
    run: (e, vars, args, settings) => {
        ...
        .addField("Get more informations", 'To know premium ranks adventages and there prices, please go on the support discord server by [clicking here](' + vars.configs.supportGuildLink + ')')
